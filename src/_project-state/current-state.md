...
- `/request-quote/` — 404 by design (forms wire up in Phase 2.06). Phase 1.16 added `prefetch={false}` on the shared `<CTA>` amber link to avoid Lighthouse `errors-in-console` deductions from the 404 RSC prefetch.

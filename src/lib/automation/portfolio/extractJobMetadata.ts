...
const SERVICE_SLUG_RULES: Array<{slug: string; keywords: string[]}> = [
  ...
  {slug: 'sewer-line-replacement', keywords: ['sewer line', 'sewer lateral', 'pipe bursting', 'sewer replacement']},
  {slug: 'missile-boring', keywords: ['missile boring', 'directional boring', 'pneumatic bore', 'under driveway bore']},
  {slug: 'conduit-installation', keywords: ['conduit', 'electrical conduit', 'fiber conduit', 'ev charger conduit']},
  {slug: 'pipe-fusing', keywords: ['pipe fusing', 'hdpe fusion', 'butt fusion', 'electrofusion']},
  {slug: 'handhole-pull-box', keywords: ['handhole', 'pull box', 'splice vault', 'junction box']},
  {slug: 'trenching-excavation', keywords: ['trenching', 'utility trench', 'open-cut trench', 'excavation']},

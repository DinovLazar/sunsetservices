...
export default function AudienceSocialProof({
  ...
  return (
    <section
      aria-labelledby={hasReviews ? 'audience-social-h2' : undefined}
      aria-label={hasReviews ? undefined : h2}
      className="bg-[var(--color-bg)] py-14 lg:py-20 [content-visibility:auto] [contain-intrinsic-size:auto_900px]"
    >
      <div className="mx-auto max-w-[var(--container-default)] px-4 sm:px-6 lg:px-8 xl:px-12">
        {/* Testimonial heading + cards render only when real reviews exist.
            Phase M.14 (Goran QA B-09 B1): the templated reviews were removed;
            until M.14b supplies real ones, this section is a credentials band. */}
        {hasReviews && (
          <>

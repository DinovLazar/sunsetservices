...
export const LOCATIONS: LocationCity[] = [
...

  {
    ...
    whyLocal: {
      ...
      es: 'North Aurora está literalmente calle arriba de nuestro patio en Mountain Street, y una parte significativa de nuestra ruta — tanto residencial como comercial — ocurre dentro de los límites del pueblo. Cortamos las subdivisiones de Stoneridge los miércoles, aramos los parques de oficinas a lo largo de Randall Road en cada tormenta, y hemos plantado en el vecindario Riverwoods cada primavera desde 2002. Los equipos saben qué calles el pueblo limpia al final en una tormenta; qué subdivisiones tienen formularios de aprobación de HOA que tardan tres semanas; qué lotes dan al Río Fox y piden trabajo de nivelación. Cuando llamas al (630) 946-9321, el mismo equipo Sunset que construyó nuestra reputación en Aurora es el equipo que contesta. Un equipo, un teléfono, veinticinco años de prestar atención.',
    },
    testimonials: [
      {
        quote: {

...
| `stock-hardscape-fire-pits-features-hero-01.jpg` | `/hardscape/fire-pits-features` | hero | https://www.pexels.com/photo/an-empty-fire-pit-surrounded-with-brown-wooden-bench-during-daytime-13871296/ | Matheus Bertelli | Pexels License | 2026-07-04 | A built stone-clad rectangular fire pit on a flagstone patio, ringed by fixed wooden bench seating under a timber pergola. | ~~2026-10-01~~ **REPLACED 2026-07-28 (Polish-02)** — superseded by a REAL Sunset project photo (`docs/photos/real/hardscape/firepit-wall-pillars-lighting.jpg`); derivatives now generated by `scripts/optimize-real-photos.mjs`; item removed from `optimize-stock-bridge.mjs` ITEMS; source retained here for the record. |

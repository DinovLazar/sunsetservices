 ...
 * Phase M.10 post-walkthrough revision (2026-05-26): reverted to
 * click-only — no hover-to-open. Children are placeholder strings in
 * Part 1 (locked in messages/*.json); Part 2.x swaps to Sanity reads

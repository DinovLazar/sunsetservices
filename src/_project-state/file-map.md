...
- `.env.local.example` — placeholder env vars for future phases. **Phase 2.02 appended** a Vercel-sync note + caveat about the CLI plugin's `action_required` JSON for preview env adds without an explicit branch.
